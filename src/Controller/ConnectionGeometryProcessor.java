...
/**
 * This class processes the user classes and finds the optimal way of drawing the connections between classes.
 */
public class ConnectionGeometryProcessor {
    ...
    /**
     * Calculates the angle between two user classes.
     */
    ...
    /**
     * This method finds the position on the panel to draw the lines between two classes.
     * @param fromAngle
     * @param toAngle
     */
    ...
    /**
     * This methods calculates and creates a point to draw a connection.
     * @param cosTheta
     * @param sinTheta
     * @param pt
     * @param i
    ...
    /**
     * This method finds the points where the connection has to be drawn between the user classes based on the angle.
     * @param side
     * @return
     */
